...
const CACHE=`${CACHE_PREFIX}v1.3.4-durable`;
...
const SHELL=[
  ...
  './assets/css/site.css?v=1.3.4',
  './assets/css/puzzle.css?v=1.2.2',
  './assets/js/main.js?v=1.3.4',
  ...
  './assets/js/backend.js?v=1.3.4',
  './assets/js/session.js?v=1.3.4',
  './assets/js/attempt-session.js?v=1.3.4',
  './assets/js/notifications.js?v=1.3.4',
  './assets/js/account.js?v=1.3.4',
  './assets/js/teacher-journal.js?v=1.3.4',
  ...
  './assets/js/grading-revisions.js?v=1.3.4',
  './assets/js/config.js?v=1.3.4',
  './assets/js/i18n.js?v=1.3.4',
  './assets/js/quiz.js?v=1.3.4',
  './assets/js/adaptive-quiz.js?v=1.3.4',
  './assets/js/access.js?v=1.3.4',
  './assets/js/puzzle-bootstrap.js?v=1.3.4',
  './assets/js/puzzle-engine.js?v=1.3.4',
