const CACHE='rudn-gmu-pages-v1.1.21';
const SHELL=[
  './','./index.html','./apps/puzzle.html',
  './assets/css/site.css?v=1.1.21',
  './assets/css/puzzle.css?v=1.1.21',
  './assets/js/main.js?v=1.1.21',
  './assets/js/backend.js?v=1.1.21',
  './assets/js/config.js?v=1.1.21',
  './assets/js/i18n.js?v=1.1.21',
  './assets/js/quiz.js?v=1.1.21',
  './assets/js/adaptive-quiz.js?v=1.1.21',
  './assets/js/access.js?v=1.1.21',
  './assets/js/puzzle-bootstrap.js?v=1.1.21',
  './assets/js/puzzle-engine.js?v=1.1.21',
