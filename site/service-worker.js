const CACHE='rudn-gmu-pages-v1.2.1';
const SHELL=[
  './','./index.html','./apps/puzzle.html',
  './assets/css/site.css?v=1.2.1',
  './assets/css/puzzle.css?v=1.2.1',
  './assets/js/main.js?v=1.2.1',
  './assets/js/backend.js?v=1.2.1',
  './assets/js/session.js?v=1.2.1',
  './assets/js/attempt-session.js?v=1.2.1',
  './assets/js/notifications.js?v=1.2.1',
  './assets/js/account.js?v=1.2.1',
  './assets/js/teacher-journal.js?v=1.2.1',
  ...
  './assets/js/grading-revisions.js?v=1.2.1',
  './assets/js/config.js?v=1.2.1',
  './assets/js/i18n.js?v=1.2.1',
  './assets/js/quiz.js?v=1.2.1',
  './assets/js/adaptive-quiz.js?v=1.2.1',
  './assets/js/access.js?v=1.2.1',
  './assets/js/puzzle-bootstrap.js?v=1.2.1',
  './assets/js/puzzle-engine.js?v=1.2.1',
