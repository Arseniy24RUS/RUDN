const dictionaries = {
  ru: {
    ...
    navDashboard:'Курс', navGradebook:'Журнал', navLive:'Общая доска', navPuzzle:'Карты', navGames:'Игры', navMaterials:'Материалы', navProfile:'Профиль', navTeacher:'Преподавателю',
    ...
    authTitle:'Вход', authSubtitle:'По студенческому билету или email', studentIdLabel:'Номер студенческого билета или email', fullNameLabel:'Фамилия, имя, отчество', groupLabel:'Учебная группа', recoveryPinLabel:'Код восстановления', authHint:'Введите номер студенческого билета или email.', rosterChecking:'Ищем профиль…', profileFound:'Профиль найден. Проверьте ФИО и группу — их можно изменить.', rosterFound:'Данные заполнены из списка студентов. Их можно изменить.', rosterMissing:'Профиль не найден. Введите ФИО и выберите группу.', adminPasswordHint:'Введите пароль преподавателя.', continue:'Продолжить', cancel:'Отмена', confirm:'Подтвердить',
    ...
    materialsTitle:'Учебные материалы', materialsLead:'Рабочая программа, презентации лекций и вопросы к экзамену.', download:'Скачать', view:'Открыть', presentation:'Презентация', programme:'Рабочая программа дисциплины', examQuestions:'Вопросы к экзамену', seminarAssignment:'Задание к семинару',
  ...
  en: {
    ...
    navDashboard:'Course', navGradebook:'Gradebook', navLive:'Shared board', navPuzzle:'Maps', navGames:'Games', navMaterials:'Materials', navProfile:'Profile', navTeacher:'Instructor',
    ...
    authTitle:'Sign in', authSubtitle:'With a student ID or email', studentIdLabel:'Student ID number or email', fullNameLabel:'Full name', groupLabel:'Study group', recoveryPinLabel:'Recovery code', authHint:'Enter your student ID number or email.', rosterChecking:'Looking for your profile…', profileFound:'Profile found. Check your name and group; both can be edited.', rosterFound:'Details filled from the student list. You can edit them.', rosterMissing:'No profile found. Enter your full name and select a group.', adminPasswordHint:'Enter your teacher account password.', continue:'Continue', cancel:'Cancel', confirm:'Confirm',
    ...
    materialsTitle:'Learning materials', materialsLead:'Course syllabus, lecture presentations and examination questions.', download:'Download', view:'Open', presentation:'Presentation', programme:'Course syllabus', examQuestions:'Examination questions', seminarAssignment:'Seminar assignment',
  ...
  zh: {
    ...
    navDashboard:'课程', navGradebook:'成绩册', navLive:'共享大屏', navPuzzle:'地图', navGames:'游戏', navMaterials:'资料', navProfile:'个人资料', navTeacher:'教师端',
    localMode:'本地模式', cloudMode:'云端同步已开启', connectionError:'无法连接数据库', loading:'正在加载平台…', signIn:'登录', signOut:'退出',
    authTitle:'登录', authSubtitle:'使用学生证号或电子邮箱', studentIdLabel:'学生证号或电子邮箱', fullNameLabel:'姓名', groupLabel:'班级', recoveryPinLabel:'恢复码', authHint:'请输入学生证号或电子邮箱。', rosterChecking:'正在查找个人资料…', profileFound:'已找到个人资料。姓名和班级均可修改。', rosterFound:'已从学生名单填写信息，您可以修改。', rosterMissing:'未找到个人资料，请填写姓名并选择班级。', adminPasswordHint:'请输入教师账号密码。', continue:'继续', cancel:'取消', confirm:'确认',
    ...
    materialsTitle:'学习资料', materialsLead:'课程大纲、讲座演示文稿和考试问题。', download:'下载', view:'打开', presentation:'演示文稿', programme:'课程教学大纲', examQuestions:'考试问题', seminarAssignment:'研讨课任务',
