const dictionaries = {
  ru: {
    ...
    liveTitle:'Общая доска квиза', liveLead:'Код и пароль не нужны. Онлайн-аналитика включается автоматически, когда одновременно отвечают несколько студентов.', join:'Подключиться', sessionCode:'Код сессии', waiting:'Ожидание ответов', answerSaved:'Ответ сохранён',
  ...
  en: {
    ...
    liveTitle:'Shared quiz board', liveLead:'No code or password is required. Live classroom analytics activates automatically when several students are answering.', join:'Join', sessionCode:'Session code', waiting:'Waiting for responses', answerSaved:'Response saved',
  ...
  zh: {
    ...
    liveTitle:'测验共享大屏', liveLead:'无需代码或密码；多名学生同时作答时，课堂实时分析会自动启用。', join:'加入', sessionCode:'会话代码', waiting:'等待作答', answerSaved:'答案已保存',
