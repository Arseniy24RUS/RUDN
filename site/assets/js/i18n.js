const dictionaries = {
  ...
  zh: {
    ...
    authTitle:'登录', authSubtitle:'使用学生证号或电子邮箱', studentIdLabel:'学生证号或电子邮箱', fullNameLabel:'姓名', groupLabel:'班级', recoveryPinLabel:'恢复码', authHint:'请输入学生证号或电子邮箱。', rosterChecking:'正在查找个人资料…', profileFound:'已找到个人资料。姓名和班级均可修改。', rosterFound:'已从学生名单填写信息，您可以修改。', rosterMissing:'未找到个人资料，请填写姓名并选择班级。', adminPasswordHint:'请输入管理员密码。', continue:'继续', cancel:'取消', confirm:'确认',
